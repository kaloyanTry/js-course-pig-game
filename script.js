...
const btnOpenModalRules = document.querySelector('.show--rules');
const btnCloseModal = document.querySelector('.modal-close');

const openModalRules = function () {
  modal.classList.remove('hidden');
  overlay.classList.remove('hidden');
};

const closeModalRules = function () {
  modal.classList.add('hidden');
  overlay.classList.add('hidden');
};

btnOpenModalRules.addEventListener('click', openModalRules);
btnCloseModal.addEventListener('click', closeModalRules);
overlay.addEventListener('click', closeModalRules);
